...
#
# [*consul_ssl_enabled*]
#   Should we use SSL for access to Consul? Defaults to false.
#
# [*consul_ssl_verify*]
#   Should we verify SSL connections? Defaults to false.
#
# [*consul_ssl_cert*]
#   Consul SSL client certificate path. Defaults to empty string.
#
# [*consul_ssl_ca_cert*]
#   Consul SSL CA certificate path. Defaults to empty string.
#
# [*vault_enabled*]
